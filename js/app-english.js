    ...
    new: {
        ...
        household: {
            ...
            words: [
                ...
                { german: 'Bürste', english: 'Brush' },
                { german: 'Besen', english: 'Broom' },
                { german: 'Eimer', english: 'Bucket' },
                { german: 'Lappen', english: 'Cloth' },
                { german: 'Seife', english: 'Soap' },
                { german: 'Shampoo', english: 'Shampoo' },
                { german: 'Handtuch', english: 'Towel' },
                { german: 'Badezimmer', english: 'Bathroom' },
                { german: 'Küche', english: 'Kitchen' },
                { german: 'Wohnzimmer', english: 'Living room' },
                { german: 'Flur', english: 'Hallway' },
                { german: 'Tür', english: 'Door' },
                { german: 'Schloss', english: 'Lock' },
                { german: 'Klingel', english: 'Doorbell' },
                { german: 'Briefkasten', english: 'Mailbox' },
                { german: 'Garten', english: 'Garden' },
                { german: 'Terrasse', english: 'Terrace' },
                { german: 'Balkon', english: 'Balcony' },
                { german: 'Garage', english: 'Garage' },
                { german: 'Keller', english: 'Basement' },
                { german: 'Dachboden', english: 'Attic' }
            ]
        },
        transport: {
            name: "Transport",
            words: [
                ...
                { german: 'Straßenbahn', english: 'Tram' },
                ...
                { german: 'Autobahn', english: 'Highway' },
                { german: 'Landstraße', english: 'Country road' },
                { german: 'Gehweg', english: 'Sidewalk' },
                { german: 'Fahrradweg', english: 'Bike path' },
                { german: 'Bushof', english: 'Bus station' },
                { german: 'Bahnhof', english: 'Train station' },
                { german: 'Flugsteig', english: 'Gate' },
                { german: 'Gepäck', english: 'Luggage' },
                { german: 'Koffer', english: 'Suitcase' },
                { german: 'Rucksack', english: 'Backpack' },
                { german: 'Fahrkarte', english: 'Ticket' },
                { german: 'Fahrplan', english: 'Schedule' },
                { german: 'Verspätung', english: 'Delay' },
                { german: 'Stau', english: 'Traffic jam' },
                { german: 'Unfall', english: 'Accident' },
                { german: 'Polizei', english: 'Police' },
                { german: 'Krankenwagen', english: 'Ambulance' },
                { german: 'Tankstelle', english: 'Gas station' },
                { german: 'Werkstatt', english: 'Workshop' },
                { german: 'Pannenhilfe', english: 'Roadside assistance' }
            ]
        },
        school: {
            name: "School & Office",
...
function createLearnCards() {
    ...
    currentVocabulary.forEach((word, index) => {
        ...
        frontFace.innerHTML = `
            ...
            ${isLearned ? '<div class="text-green-500 text-sm mt-1">✓ Learned (5x correct)</div>' : 
...
function checkAnswer(selectedAnswer, correctAnswer, button) {
    ...
    if (selectedAnswer === correctAnswer) {
        ...
        document.getElementById('test-feedback').textContent = 'Wrong! 👎';
