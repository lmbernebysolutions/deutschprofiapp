...
const vocabularyData = {
    ...
    new: {
        food: {
            name: { en: "Food & Drinks", so: "Cunto iyo Cabitaan" },
            words: [
                { german: 'Flasche', english: 'Bottle', somali: 'Dhalo' },
                { german: 'Saft', english: 'Juice', somali: 'Caano miro' },
                { german: 'Süßigkeit', english: 'Candy', somali: 'Macaan' },
                { german: 'Gurke', english: 'Cucumber', somali: 'Qajaar' },
                { german: 'Obst', english: 'Fruit', somali: 'Miro' },
                { german: 'Gemüse', english: 'Vegetables', somali: 'Khudaar' },
                { german: 'Hähnchenfleisch', english: 'Chicken meat', somali: 'Hilib digaag' },
                { german: 'Zitrone', english: 'Lemon', somali: 'Liim' },
                { german: 'Orange', english: 'Orange', somali: 'Liim' },
                { german: 'Birne', english: 'Pear', somali: 'Kambuur' },
                { german: 'Topf', english: 'Pot', somali: 'Digaag' },
                { german: 'Rindfleisch', english: 'Beef', somali: 'Hilib lo' },
                { german: 'Paprika', english: 'Bell pepper', somali: 'Basbaas' },
                { german: 'Weintraube', english: 'Grape', somali: 'Canab' },
                { german: 'Schlüssel', english: 'Key', somali: 'Furaha' },
                { german: 'Käse', english: 'Cheese', somali: 'Kees' },
                { german: 'Wurst', english: 'Sausage', somali: 'Suus' }
            ]
        },
        household: {
            name: { en: "Household", so: "Guriga" },
